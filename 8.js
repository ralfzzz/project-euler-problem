function largestProductinaSeries(n) {
    ...
    for (let i = 0; i < thousandDigits.length; i++) {
      var slicedArray = thousandDigits.slice(i,(i+n));
      var timesAccumulator = slicedArray.reduce((accumulator,currentValue) => {
        return accumulator*currentValue;
      });
  
      if(greatestProduct<timesAccumulator){
        greatestProduct = timesAccumulator;
      }
    }
